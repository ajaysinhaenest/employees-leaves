...
const ChangePassword = ({ user, changePassword, setChangePassword }: Props) => {
    const form = useMemo(
    ...
    const handleChangePassword = () => {
        ...
        localStorageService.setUsersList(updatedUsers)
        localStorageService.setEmployeesList(updatedEmployees)
...
export default inject('employeeStore')(observer(ChangePassword))
